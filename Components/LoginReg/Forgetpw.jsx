      ...
      <div className="login-main-con">
        ...
        <div className="form-con">
          <form className="login-form" onSubmit={handleSubmit(onSubmit)}>
            <p style={{ color: "red", textAlign: "center" }}>{regErrMessage}</p>
...
function EnterOTP({ setNotificationModal, router }) {
  ...
  useEffect(() => {
    if (otpNotificationModal === "SUCCESS") {
      ...
      notifications.show({
        title: "Notification",
        message: "Password change successful, Proceed to login",
      });
    }
    if (regErrMsg) {
      notifications.show({
